...
Route::group(['namespace' => 'App\Http\Controllers'], function(){
     ...
     //   Route::get('region/template', [App\Http\Controllers\frontReportController::class, 'regionTemplate'])->name('region.temp');
        ...
        Route::post('add-cart',['as' => 'add.to.cart', 'uses' => 'CartController@addCart']);
...
Route::group(['as'=> 'customer.','prefix'=>'customer','middleware' => 'auth','namespace'=>'App\Http\Controllers\Customer'], function () {
    ...
    Route::get('orderDetail/{id}',  ['as' => 'orderDetail','uses' => 'userController@orderDetails']);
...
Route::group(['as'=> 'admin.','prefix'=>'admin','middleware' => 'auth', 'namespace'=>'App\Http\Controllers\Admin'], function () {
    ...
    Route::get('requirements',         ['as' => 'requirements','uses' => 'RequirmentController@index']);
    Route::get('requirements/applied/user',         ['as' => 'applied.user','uses' => 'RequirmentController@appliedUser']);
    Route::post('requirements/applied/user/delete',         ['as' => 'requirements.user.delete','uses' => 'RequirmentController@appliedUserDelete']);
    ...
    Route::get('report/article/template',     ['as' => 'report.article.template','uses' => 'reportController@articleTemplate']);
    Route::post('report/article/template/update',     ['as' => 'report.article.template.update','uses' => 'reportController@articleTemplateUpdate']);
    Route::get('report/article/category',     ['as' => 'report.article.category','uses' => 'reportController@category']);
    Route::post('report/article/category/save',     ['as' => 'report.article.category.save','uses' => 'reportController@categorySave']);
    Route::post('report/article/category/update',     ['as' => 'report.article.category.update','uses' => 'reportController@categoryUpdate']);
    Route::post('report/article/category/delete',     ['as' => 'report.article.category.delete','uses' => 'reportController@categoryDelete']);
